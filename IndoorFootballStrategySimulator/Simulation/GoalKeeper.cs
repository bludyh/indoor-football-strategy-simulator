...
namespace IndoorFootballStrategySimulator.Simulation
{
    ...
    public class GoalKeeper : Player
    {
        ...
        public Vector2 GetRearInterposeTarget() {
            ...
            float yPosTarget = Field.PlayingArea.Center.Y- Vector2.Distance(Team.HomeGoal.LeftPostPos,Team.HomeGoal.RightPostPos)*0.5f
                +(Ball.Position.Y * Vector2.Distance(Team.HomeGoal.LeftPostPos, Team.HomeGoal.RightPostPos)) / Field.PlayingArea.Height;

            return new Vector2(xPosTarget,yPosTarget);
        }

        public bool BallWithinRangeForIntercept() {
            return (Vector2.DistanceSquared(Team.HomeGoal.Center, SimulationWindow.EntityManager.Ball.Position) < (100f *100f));
        }
    }
}
